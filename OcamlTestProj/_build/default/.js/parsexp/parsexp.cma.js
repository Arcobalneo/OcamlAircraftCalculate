   ...
   {"use strict";
    ...
    function sub_sexp_count(sexp)
     {if(0 === sexp[0])return 1;
      ...
      return caml_call3(Stdlib_listLabels[25],_bh_,_bg_,l)}
    ...
    function loop_list(sub,index,sexps)
     {function _bd_(_be_,_bf_){return loop(sub,_be_,_bf_)}
      return caml_call3(Stdlib_listLabels[25],_bd_,index,sexps)}
    ...
    function report(ppf,filename,t)
     {var _a6_=t[3];
      ...
      return caml_call7
              (Stdlib_format[126],ppf,_C_,filename,line,start,stop,_a7_)}
    var
     Of_sexp_error$0=
    ...
    function report$0(ppf,filename,t)
     {var pos=t[1],msg=t[2];
      return caml_call6(Stdlib_format[126],ppf,_I_,filename,pos[1],pos[2],msg)}
       ...
       {case 0:var message=cst_unterminated_hexadecimal_e;break;
        ...
        case 8:
         var
          ...
          message=
           caml_call2(Stdlib_string[4],_a4_,cst$0)
            ?cst_illegal_end_of_comment
            :cst_comment_tokens_in_unquoted;
         break;
       ...
       {var switch$1=0;
        if(8 === reason)
         {var _a3_=caml_call1(Stdlib_buffer[2],atom_buffer);
          if(caml_call2(Stdlib_string[4],_a3_,cst))
    ...
    function apply_f$0(x,f)
     {var _af_=caml_call2(Stdlib_listLabels[21],f,x);
