(function(joo_global_object)
   {"use strict";
    ...
    function entire_module_disabled(t,tags)
     {var _bY_=t[2];
      function _bZ_(dropped){return caml_call2(Stdlib_list[36],dropped,tags)}
      return caml_call2(Stdlib_list[33],_bZ_,_bY_)}
    function disabled(t,tags)
     {var _bT_=t[1];
      function _bU_(req){return 1 - caml_call2(Stdlib_list[36],req,tags)}
      var _bV_=caml_call2(Stdlib_list[33],_bU_,_bT_);
      if(_bV_)return _bV_;
      var _bW_=t[2];
    ...
    function current_tags(param)
     {var _bP_=current$0[1];
      ...
      var _bO_=caml_call2(Stdlib_list[19],_bN_,_bP_);
                   ...
                   function(filename)
                    {try
                     ...
                     if(match)
                      ...
                      if(caml_call2(Stdlib_string[8],filename,58))
                       {var
                         i=caml_call2(Stdlib_string[25],filename,58),
                         filename$1=caml_call3(Stdlib_string[9],filename,0,i),
                         index_string=
                          caml_call3
                           (Stdlib_string[9],
                            filename,
                  ...
                  [4,
                   function(s)
                    {var _bu_=tag_predicate[1],_br_=_bu_[2];
                     ...
                     var _bt_=caml_call2(Stdlib_list[41],_bs_,_br_);
                  ...
                  [4,
                   function(s)
                    {var _bp_=tag_predicate[1],_bm_=[0,s,_bp_[2]],_bn_=_bp_[1];
                     ...
                     tag_predicate[1]
                     =
                     [0,caml_call2(Stdlib_list[41],_bo_,_bn_),_bm_];
                     return 0}],
                  cst_tag_Only_run_tests_not_tag],
                 _U_],
               _W_=
    ...
    function string_of_module_descr(param)
     {var _a6_=current$0[1];
      ...
      var _a5_=caml_call2(Stdlib_list[19],_a4_,_a6_);
      function _a7_(s)
       {var
         _a9_=caml_call1(Stdlib_string[18],s),
      ...
      var _a8_=caml_call2(Stdlib_list[19],_a7_,_a5_);
      return caml_call2(Stdlib_string[3],cst$4,_a8_)}
    function position_match(def_filename,def_line_number,l)
     {function _aY_(param)
       {var
        ...
        if(found)used[1] = 1;
        return found}
      return caml_call2(Stdlib_list[33],_aY_,l)}
     ...
     {var delayed_errors$0=caml_call1(Stdlib_list[9],delayed_errors[1]);
      if(delayed_errors$0)
       {var _aW_=caml_call2(Stdlib_string[1],70,61);
        ...
        return caml_call2(Stdlib_list[17],_aX_,delayed_errors$0)}
      return 0}
          ...
          try
           ...
           {exn = caml_wrap_exception(exn);
            ...
            var
             ...
             sep=caml_call2(Stdlib_string[8],exn_str,10)?cst$5:cst$6,
         ...
         {test_modules_ran[1]++;
          ...
          try
           ...
           {exn = caml_wrap_exception(exn);
            ...
            var
             exn_str=caml_call1(Stdlib_printexc[1],exn),
             sep=caml_call2(Stdlib_string[8],exn_str,10)?cst$8:cst$9,
             _ay_=string_of_module_descr(0),
             _az_=caml_call1(Stdlib_string[18],descr$1);
            return caml_call5
     ...
     {var match=get(0);
      ...
      if(typeof _ai_[2] === "number")
       {var
         ...
         _ag_=caml_call2(Stdlib_list[56],Stdlib_string[5],_af_),
